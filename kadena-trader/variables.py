...
[CODE]
// Predefined parameters for the baseline function
// These parameters are predefined within the execution environment
...
CODER_PROMPT = """
    ...
    2. Generate code:
     ...
     Notes:
          ...
          > - Maintain a high level of verbosity in each action taken by the agent.
